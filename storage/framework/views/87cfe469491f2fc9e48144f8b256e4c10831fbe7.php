                ...
                <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="<?php echo e(asset('assets/imgs/shop/product-7-1.jpg')); ?>" alt="">
                                                <img class="hover-img" src="<?php echo e(asset('assets/imgs/shop/product-7-2.jpg')); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="<?php echo e(asset('assets/imgs/shop/product-1-2.jpg')); ?>" alt="">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="<?php echo e(asset('assets/imgs/shop/product-5-2.jpg')); ?>" alt="">
                                                <img class="hover-img" src="<?php echo e(asset('assets/imgs/shop/product-5-2.jpg')); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="<?php echo e(asset('assets/imgs/shop/product-8-2.jpg')); ?>" alt="">
                                                <img class="hover-img" src="<?php echo e(asset('assets/imgs/shop/product-8-1.jpg')); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="<?php echo e(asset('assets/imgs/shop/product-11-1.jpg')); ?>" alt="">
                                                <img class="hover-img" src="<?php echo e(asset('assets/imgs/shop/product-11-2.jpg')); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="<?php echo e(asset('assets/imgs/shop/product-13-1.jpg')); ?>" alt="">
                                                <img class="hover-img" src="<?php echo e(asset('assets/imgs/shop/product-13-2.jpg')); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="<?php echo e(asset('assets/imgs/shop/product-7-2.jpg')); ?>" alt="">
                                                <img class="hover-img" src="<?php echo e(asset('assets/imgs/shop/product-7-1.jpg')); ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
                            <img src="<?php echo e(asset('assets/imgs/banner/banner-11.jpg')); ?>" alt="">
...
<?php /**PATH /Users/netrialiarahmi/webalia/resources/views/livewire/shop-component.blade.php ENDPATH**/ ?>