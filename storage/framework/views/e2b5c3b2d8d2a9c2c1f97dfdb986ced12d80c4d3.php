                ...
                <div class="row align-items-center">
                        ...
                        <ul>
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li><a href="#"><img src="<?php echo e(asset('assets/imgs/theme/flag-fr.png')); ?>" alt="">Français</a></li>
                                        <li><a href="#"><img src="<?php echo e(asset('assets/imgs/theme/flag-dt.png')); ?>" alt="">Deutsch</a></li>
                                        <li><a href="#"><img src="<?php echo e(asset('assets/imgs/theme/flag-ru.png')); ?>" alt="">Pусский</a></li>
                                    </ul>
                                </li>                                
                            </ul>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li>Dapatkan Penawaran Spesial Dengan Diskon Hingga 50% <a href="shop.html">View details</a></li>
                                    <li>Supper Value Deals - Hemat dengan kupon</li>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            ...
                            <ul>                                
                                <li><i class="fi-rs-user"></i><a <?php echo e(Auth::user()->name); ?>/
                                    <method="post" form action="<?php echo e(route('logout')); ?>" >
                                        <?php echo csrf_field(); ?>
                                        <a href="<?php echo e(route('logout')); ?>" onclick="even.preventDefault(); this.closest('form').submit();">Logout</a>
                                    </form>
                                </li>
                            </ul>
                            <?php else: ?>
                            <ul>                                
                                <li><i class="fi-rs-key"></i><a href="<?php echo e(route('login')); ?>">Log In </a>  / <a href="<?php echo e(route('register')); ?>">Sign Up</a></li>
                            </ul>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="index.html"><img src="<?php echo e(asset('assets/imgs/logo/logo.png')); ?>" alt="logo"></a>
                    </div>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product-details.html"><img alt="Surfside Media" src="<?php echo e(asset('assets/imgs/shop/thumbnail-3.jpg')); ?>"></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product-details.html"><img alt="Surfside Media" src="<?php echo e(asset('assets/imgs/shop/thumbnail-2.jpg')); ?>"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                ...
                <div class="header-wrap header-space-between position-relative">
                                            ...
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="<?php echo e(asset('assets/imgs/banner/menu-banner-2.jpg')); ?>" alt="menu_banner1">
                                                    ...
                                                    <div class="header-banner2">
                                                        <img src="<?php echo e(asset('assets/imgs/banner/menu-banner-3.jpg')); ?>" alt="menu_banner2">
                                                        <div class="banne_info">
                                                            <h6>15% Off</h6>
                                                            <h4>Hot Deals</h4>
                                                            <a href="#">Shop now</a>
                                    ...
                                    <li class="has-children">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="<?php echo e(asset('assets/imgs/banner/menu-banner-4.jpg')); ?>" alt="menu_banner1">
                                                        <div class="banne_info">
                                                            <h6>10% Off</h6>
                                                            <h4>New Arrival</h4>
                                                            <a href="#">Shop now</a>
                                    ...
                                    <li class="has-children">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="<?php echo e(asset('assets/imgs/banner/menu-banner-5.jpg')); ?>" alt="menu_banner1">
                                                        <div class="banne_info">
                                                            <h6>10% Off</h6>
                                                            <h4>New Arrival</h4>
                                                            <a href="#">Shop now</a>
                                                    ...
                                                    <div class="header-banner2">
                                                        <img src="<?php echo e(asset('assets/imgs/banner/menu-banner-6.jpg')); ?>" alt="menu_banner2">
                                                        <div class="banne_info">
                                                            <h6>15% Off</h6>
                                                            <h4>Hot Deals</h4>
                                                            <a href="#">Shop now</a>
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="product-details.html"><img src="<?php echo e(asset('assets/imgs/banner/menu-banner.jpg')); ?>" alt="Surfside Media"></a>
                    ...
                    <div class="header-action-right d-block d-lg-none">
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="shop-wishlist.php">
                                    <img alt="Surfside Media" src="<?php echo e(asset('assets/imgs/theme/icons/icon-heart.svg')); ?>">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="Surfside Media" src="<?php echo e(asset('assets/imgs/shop/thumbnail-4.jpg')); ?>"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                    ...
                    <div class="col-lg-7 mb-md-3 mb-lg-0">
                        <div class="row align-items-center">
                            <div class="col flex-horizontal-center">
                                <img class="icon-email" src="<?php echo e(asset('assets/imgs/theme/icons/icon-email.svg')); ?>" alt="">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-lg-12">
                                ...
                                <div class="download-app wow fadeIn animated mob-app">
                                    ...
                                    <a href="#" class="hover-up"><img src="<?php echo e(asset('assets/imgs/theme/google-play.jpg')); ?>" alt=""></a>
                                </div>
                            </div>
...
</html><?php /**PATH /Users/netrialiarahmi/webalia/resources/views/layouts/app.blade.php ENDPATH**/ ?>